...
bool processFrame(const cv::Mat& cameraFrame, MarkerDetector& markerDetector, DrawingContext& drawingCtx)
{
...
int main(int argc, char *argv[]) {
    ...
    DrawingContext drawingCtx(frameSize, calibration);
	...
	win = XCreateWindow(dpy, root, 0, 0, frameWidth, frameHeight, 0, vi->depth, InputOutput, vi->visual, CWColormap | CWEventMask, &swa);
