...
int main(int argc, const char * argv[])
{
    ...
    //~ string nameOBJ = "cube";
    //~ string nameOBJ = "Tiger";
    //~ string filepathOBJ = "source/Tiger/" + nameOBJ + ".obj";
    //~ string filepathMTL = "source/Tiger/" + nameOBJ + ".mtl";
    //~ string filepathH = "product/" + nameOBJ + ".h";
    //~ string filepathC = "product/" + nameOBJ + ".c";
    string nameOBJ = "couch";
    string filepathOBJ = "source/couch/" + nameOBJ + ".obj";
    string filepathMTL = "source/couch/" + nameOBJ + ".mtl";
    string filepathH = "product/" + nameOBJ + ".h";
    string filepathC = "product/" + nameOBJ + ".c";
