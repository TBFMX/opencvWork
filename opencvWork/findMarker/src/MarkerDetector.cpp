...
bool MarkerDetector::processFrame(const cv::Mat& bgraMat)
{
...
//~ #ifdef SHOW_DEBUG_IMAGES
        //~ {
			...
			//~ cv::imwrite("Source marker" + ToString(i) + ".png",  markerSubImage);
            //~ cv::imshow("Marker " + ToString(i) + " after warp", canonicalMarkerImage);
			//~ cv::imwrite("Marker " + ToString(i) + " after warp" + ".png",  canonicalMarkerImage);
        //~ }
//~ #endif
